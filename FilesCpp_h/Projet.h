...
class Clan
{
	...
	public:
		...
		string GetClanName();			//Recuperer le nom du clan
...
class Attributes
{
	...
	public:
		...
		int check_attributspoint(string , int, int, int ); //pour tester l'attribution des points aux attributs 
};


/********************************************************************************************************/
/* Cette classe memorize et manipule les donnees des abilities*/
class Abilities
{
	protected:
		int point;
...
class OtherTraits
{
	...
	public:	
		...
		deque<string> flaws_list();		//liste des flaws 
};
...
class Fenetre : public Gtk::Window
{
	...
	void on_combobackground_changed() ; //signal de changement des background 
	...
	void on_combomerits_changed();	//signal de changement des merits
	void on_combomerits1_changed();
	void on_combomerits2_changed();
	void on_comboflaws_changed();	//signal de changement des flaws
	void on_comboflaws1_changed();
	void on_comboflaws2_changed();
	...
	Gtk::SpinButton spin_conscience, spin_selfControl, spin_courage;
	 ...
	 Gtk::Label humanity_label, humanity_score;
   	...
   	Gtk::ComboBoxText merits1_combo, merits2_combo, merits3_combo ;
	deque<string> merits_list;		 
    	Gtk::SpinButton spin_merits1, spin_merits2, spin_merits3 ;         
  	
  	Gtk::Label flaws_label;
   	Gtk::ComboBoxText flaws1_combo, flaws2_combo, flaws3_combo ;
	deque<string> flaws_list;		 
    	Gtk::SpinButton spin_flaws1, spin_flaws2, spin_flaws3 ;       
    	 ...
    	 //Expanded background 
    	 Gtk::Label expandedBackground_label, allies_label , contacts_label , fame_label, herd_label, influence_label , mentor_label , resources_label , retainers_label , status_label  ;
    	 Gtk::Entry allies_entry , contacts_entry , fame_entry, herd_entry, influence_entry , mentor_entry , resources_entry , retainers_entry , status_entry ;
